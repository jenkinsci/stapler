        ...
        switch (SessionTrackingMode.this) {
            ...
            default:
                throw new IllegalArgumentException(
                        "Unknown SessionTrackingMode: " + SessionTrackingMode.this);
        }
    }

    public static SessionTrackingMode fromJakartaSessionTrackingMode(
            jakarta.servlet.SessionTrackingMode from) {
        switch (from) {
            case COOKIE:
