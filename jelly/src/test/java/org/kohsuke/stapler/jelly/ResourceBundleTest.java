...
class ResourceBundleTest {
    ...
    @Test
    void formatFallsBackToDefaultIfMissing() {
    ...
    @Test
    void formatLocaleOverrideInPlace() {
    ...
    @Test
    void formatLocaleNonISO_8859_1() {
    ...
    @Test
    void formatLocaleNonISO_8859_1_encoded_with_utf8() {
    ...
    @Test
    void formatLocaleISO_8859_1_high_range_character_invalid_utf_8() {
