...
public interface HttpServletRequest extends ServletRequest {
    ...
    default jakarta.servlet.http.HttpServletRequest toJakartaHttpServletRequest() {
        return new jakarta.servlet.http.HttpServletRequest() {
            ...
            @Override
            public boolean authenticate(jakarta.servlet.http.HttpServletResponse httpServletResponse)
                    throws IOException, jakarta.servlet.ServletException {
                try {
                    return HttpServletRequest.this.authenticate(
                            HttpServletResponse.fromJakartaHttpServletResponse(httpServletResponse));
